...
class MultiDynamic(Base3DDetector):
    """Base class of Multi-modality Dynamic."""
    ...
    def __init__(self,
                 ...
                 test_cfg=None,
                 pretrained=None):
        super(MultiDynamic, self).__init__()
    ...
    def init_weights(self, pretrained=None):
        ...
        super(MultiDynamic, self).init_weights(pretrained)
    ...
    def extract_img_feat(self, img, img_metas):
        ...
        if self.with_img_backbone and img is not None:
            ...
            #print('img shape',img.shape)    img shape torch.Size([2, 3, 416, 1344])
            img_feats = self.img_backbone(img)
            #print('2 img_feats shape',img_feats[0].shape)  # torch.Size([2, 256, 104, 336])
            #print('2 img_feats shape',img_feats[1].shape)  #torch.Size([2, 512, 52, 168])
            #print('2 img_feats shape',img_feats[2].shape)  #torch.Size([2, 1024, 26, 84])
            #print('2 img_feats shape',img_feats[3].shape)  #torch.Size([2, 1024, 26, 84])
