...
import mmdet3d.ops.pointnet3.pointnet3_cuda as pointnet3
...
class ThreeNN(Function):
    ...
    def forward(ctx, unknown: torch.Tensor, known: torch.Tensor) -> Tuple[torch.Tensor, torch.Tensor]:
        ...
        pointnet3.three_nn_wrapper(N, m, unknown, known, dist2, idx)
...
class ThreeInterpolate(Function):
    ...
    def forward(ctx, features: torch.Tensor, idx: torch.Tensor, weight: torch.Tensor) -> torch.Tensor:
        ...
        pointnet3.three_interpolate_wrapper(c, m, n, features, idx, weight, output)
        return output
    ...
    def backward(ctx, grad_out: torch.Tensor) -> Tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
        ...
        pointnet3.three_interpolate_grad_wrapper( c, n, m, grad_out_data, idx, weight, grad_features.data)
